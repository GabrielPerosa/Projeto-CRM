                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                required
                                className="w-full p-3 mt-2 bg-blue-200 text-white rounded-md"
                        ...
                        <div className="mb-4">
                            ...
                            <div className="relative w-full">
                                <input
                                    ...
                                    className="w-full p-3 bg-blue-200 text-white rounded-md pr-10"
                        ...
                        <div className="text-center mt-8">
                            <button type="submit" className="w-full p-3 rounded-md bg-gradient-to-r from-blue-300 to-blue-400 text-white font-semibold">
                                Entrar
                            </button>
                        </div>
