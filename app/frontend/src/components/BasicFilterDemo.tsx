...
export default function AdvancedFilterDemo() {
    ...
    useEffect(() => {
        ...
        customerService.getCustomersMedium().then((data) => {
            // Garantir que o tipo de 'data' é 'Customer[]'
            setCustomers(data as Customer[]); // Cast explicitamente para Customer[]
            setLoading(false);
        });
    ...
    const renderHeader = () => {
        return (
            <div className="flex justify-content-between items-center">
                ...
                <div className="absolute right-0 top-0 mt-3 mr-3 flex items-center">
                    <InputIcon className="pi pi-search mr-2" />
    ...
    return (
        <div className="card">
            <DataTable value={customers} paginator showGridlines rows={10} loading={loading} dataKey="id"
                ...
                <Column header="Cidade-Estado" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate}
